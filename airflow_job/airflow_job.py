...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="airflow-project-gds-dev11")
    bq_project = Variable.get("bq_project", default_var="project-f6c925e6-c3bf-44a1-a0f")
    ...
    file_sensor = GCSObjectExistenceSensor(
        ...
        bucket=gcs_bucket,
        object=f"flight_booking_analysis/source-{env}/flight_booking.csv",  # Full file path in GCS
    ...
    batch_details = {
        "pyspark_batch": {
            "main_python_file_uri": f"gs://{gcs_bucket}/flight_booking_analysis/spark-job/spark_transformation_job.py",  # Main Python file
        ...
        "runtime_config": {
            "version": "2.2",
            "properties": {
                "spark.driver.cores": "4",       # minimum allowed ✅
                "spark.driver.memory": "4g",
                "spark.executor.cores": "4",     # minimum allowed ✅
                "spark.executor.memory": "4g",
                "spark.executor.instances": "1", # 4+4×1 = 8 CPUs ✅
            }
        },
        "environment_config": {
            "execution_config": {
